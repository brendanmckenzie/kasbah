...
namespace Kasbah.DataAccess
{
    ...
    {
        Task PutEntryAsync<T>(string index, Guid id, T data, Guid? parent = null, bool waitForCommit = true);
        Task PutEntryAsync<T>(string index, Guid id, IDictionary<string, object> data, Guid? parent = null, bool waitForCommit = true);
        Task PutEntryAsync(string index, Guid id, Type type, IDictionary<string, object> data, Guid? parent = null, bool waitForCommit = true);
